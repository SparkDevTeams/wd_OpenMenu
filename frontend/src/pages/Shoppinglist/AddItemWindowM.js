      ...
      <div className="window-box">
        <div className="windowHeader">
          ...
          <div className="recipes-checkbox-container">
            <Checkbox checked={props.recipesChecked} onChange={props.toggleRecipeCheckFunction}/>
            <p className="recipes-filter-text">Recipes</p>
          </div>
          <div className="items-checkbox-container">
            <Checkbox checked={props.itemsChecked} onChange={props.toggleItemCheckFunction}/>
